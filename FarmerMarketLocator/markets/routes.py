...
#show market profile, api call for specific market
...
def toggle_favorite_market(market_id):
    ...
    if favorite is False:
        try:
            ...
            flash('Added market to favorites!','success')
        ...
        try:
            ...
            flash('Removed market from favorites.','success')
            return redirect(url_for('markets.show_market',market_id=market_id))
        except:
            abort(405)
# user account required to add commen to market profiles
